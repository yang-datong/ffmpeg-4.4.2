...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/hi/ffmpeg-4.4.2/build --extra-cflags='-O0 -g3 -Wno-deprecated-declarations' --enable-shared --disable-static --enable-small --enable-gpl --enable-libx264 --enable-libx265 --enable-protocol=tcp --enable-protocol=udp --enable-protocol=rtp --enable-demuxer=rtsp --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffprobe --disable-avdevice --disable-swresample --disable-postproc --enable-protocol=tcp --enable-protocol=udp --enable-protocol=rtp --enable-demuxer=rtsp --disable-asm --disable-mmx --disable-sse --disable-avx --disable-vfp --disable-neon --disable-inline-asm --disable-x86asm --disable-mipsdsp --enable-debug=3 --disable-optimizations --ignore-tests=TESTS
...
CC_IDENT=gcc 13 (Ubuntu 13.2.0-23ubuntu4)
ARCH=c
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
CFLAGS=  -O0 -g3 -Wno-deprecated-declarations -std=c11 -fPIC -pthread  -I/home/hi/x264-master/build/include -DX264_API_IMPORTS -I/home/hi/x265_3.6/build/linux_amd64/include    -g3 -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -O0 -g3 -Wno-deprecated-declarations -fPIC -g3
...
EXTRALIBS-avcodec=-pthread -lm -lz -L/home/hi/x264-master/build/lib -lx264 -L/home/hi/x265_3.6/build/linux_amd64/lib -lx265 -lva
EXTRALIBS-swresample=-lm
EXTRALIBS-avresample=-lm
EXTRALIBS-avutil=-pthread -lva-drm -lva -lm -lva
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
