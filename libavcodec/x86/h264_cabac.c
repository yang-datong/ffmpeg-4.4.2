...
static int decode_significance_x86(CABACContext *c, int max_coeff,
  ...
  __asm__ volatile(
      ...
      BRANCHLESS_GET_CABAC("%4", "%q4", "(%1)", "%3", "%w3", "%5", "%q5", "%k0",
                           "%b0", "%c11(%6)", "%c12(%6)",
                           AV_STRINGIFY(H264_NORM_SHIFT_OFFSET),
                           AV_STRINGIFY(H264_LPS_RANGE_OFFSET),
                           AV_STRINGIFY(H264_MLPS_STATE_OFFSET), "%13")
      ...
      : "=&q"(coeff_count), "+r"(significant_coeff_ctx_base), "+m"(index),
        "+&r"(c->ivlOffset), "=&r"(bit), "+&r"(c->ivlCurrRange)
...
static int decode_significance_8x8_x86(CABACContext *c,
  ...
  __asm__ volatile(
      ...
      BRANCHLESS_GET_CABAC("%4", "%q4", "(%6)", "%3", "%w3", "%5", "%q5", "%k0",
                           "%b0", "%c12(%7)", "%c13(%7)",
                           AV_STRINGIFY(H264_NORM_SHIFT_OFFSET),
                           AV_STRINGIFY(H264_LPS_RANGE_OFFSET),
                           AV_STRINGIFY(H264_MLPS_STATE_OFFSET), "%15")
      ...
      BRANCHLESS_GET_CABAC("%4", "%q4", "(%6)", "%3", "%w3", "%5", "%q5", "%k0",
          ...
          "addl %8, %k0                           \n\t"
          "shr $2, %k0                            \n\t"
      : "=&q"(coeff_count), "+" REG64(last), "+" REG64(index),
        "+&r"(c->ivlOffset), "=&r"(bit), "+&r"(c->ivlCurrRange), "=&r"(state)
